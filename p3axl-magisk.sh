...
[init.svc.pS1lSb1XpK1HLd]: [stopped]
...
[init.svc.sk0gh1h8Q7krdyT]: [stopped]
...
[persist.sys.boot.reason.history]: [reboot,,1583684481
bootloader,1583684425
reboot,factory_reset,1583683978]
...
[ro.boot.boottime]: [0BLE:82,1BLL:61,1BLE:446,2BLL:126,2BLE:1071,SW:10021,KL:0,KD:101,ODT:122,AVB:50]
...
[sys.system_server.start_elapsed]: [7581]
[sys.system_server.start_uptime]: [7581]
[sys.usb.config]: [adb]
[sys.usb.configfs]: [2]
